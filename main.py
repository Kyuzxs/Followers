...
administrators = [941228508397592577] 
chat_channel = 973752885819113515
bots_channel = 973753034289070122
queue = []
...
async def on_ready():
    ...
    while True:
        ...
        activity = discord.Activity(type=discord.ActivityType.watching, name=f'{members} users | Snøw')
...
async def on_member_join(member):
    ...
    await channel.send(f'Welcome to **Snøw**, {member.mention}.\nType `/help` to get started! Yey!')
